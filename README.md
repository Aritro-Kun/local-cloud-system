...
Now let's try to retrieve the system's IP address, manually it's possible to do by typing `ipconfig /all` in your windows terminal or if you are in mac, hold on get the jargons and the intuition for now, I have to give you a detailed description of the stuffs.
